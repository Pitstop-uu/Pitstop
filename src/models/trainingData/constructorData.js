 const trainingDataConstructors = [
    ...
    //alpine
    //{ input: { year: 2018, mercedes: 0, redbull: 0, alpine:1, haas:0, mclaren:0, ferrari:0,williams:0,astonmartin:0,kicksauber:0,RB:0, points: 122 }, output: { nextYearPoints: 91 } },
    //{ input: { year: 2019, mercedes: 0, redbull: 0, alpine: 1, haas:0, mclaren:0,ferrari:0,williams:0,astonmartin:0,kicksauber:0,RB:0, points: 91 }, output: { nextYearPoints: 181 } },
    { input: { year: 2020, mercedes: 0, redbull: 0, alpine: 1, haas:0,mclaren:0, ferrari:0,williams:0,astonmartin:0,kicksauber:0,RB:0, points: 181 }, output: { nextYearPoints: 155 } },
    { input: { year: 2021, mercedes: 0, redbull: 0, alpine: 1, haas:0,mclaren:0, ferrari:0,williams:0,astonmartin:0,kicksauber:0,RB:0,  points: 155 }, output: { nextYearPoints: 173 } },
    { input: { year: 2022, mercedes: 0, redbull: 0, alpine: 1, haas:0,mclaren:0, ferrari:0,williams:0,astonmartin:0,kicksauber:0,RB:0, points: 173 }, output: { nextYearPoints: 120 } },
    { input: { year: 2023, mercedes: 0, redbull: 0, alpine: 1, haas:0,mclaren:0, ferrari:0,williams:0,astonmartin:0,kicksauber:0,RB:0, points: 120 }, output: { nextYearPoints: 65 } },   ];
