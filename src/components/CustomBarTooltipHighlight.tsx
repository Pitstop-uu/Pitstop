...
export default function CustomTooltipHighlight({ highlightedItem, axisValue, datapoints, allDrivers, driverConstructors, displayPoints }: CustomBarTooltipHighlightProps) {
